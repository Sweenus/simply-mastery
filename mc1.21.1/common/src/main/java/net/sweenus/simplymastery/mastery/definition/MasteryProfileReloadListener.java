...
import net.sweenus.simplymastery.mastery.network.ProfileSyncPacket;
...
import net.sweenus.simplymastery.mastery.reward.RewardCatalogFactory;
import net.sweenus.simplymastery.mastery.reward.RewardDefinitionLoader;
...
public final class MasteryProfileReloadListener implements SynchronousResourceReloader {
    ...
    private static void log(String error) {
        LoggerFactory.getLogger("Simply Mastery/Rewards")
