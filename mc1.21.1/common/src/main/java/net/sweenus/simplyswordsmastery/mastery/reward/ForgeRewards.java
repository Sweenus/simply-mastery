...
import net.sweenus.simplyswordsmastery.mastery.network.RewardDisplayPacket;
...
import net.sweenus.simplyswordsmastery.mixin.ForgeRewardsAccessor;
    ...
    public static void handle(ServerPlayerEntity player, NbtCompound request) {
        ...
        if (!action.isEmpty()) {
            ...
            if (!envelope) message = "stale";
                ...
                ((ForgeRewardsAccessor) forge).simplyswordsmastery$refreshRewardsPreview();
