...
import net.sweenus.simplyswordsmastery.mastery.effect.AbilitySkillEffectType;
import net.sweenus.simplyswordsmastery.mastery.effect.SkillEffectRegistry;
import net.sweenus.simplyswordsmastery.mastery.effect.StaticAbilitySkillEffectType;
...
public final class MasteryCooldownTooltip {
    ...
    public static void init() {
        TooltipUtils.registerCooldownFormatter(Identifier.of("simplyswordsmastery", "mastery"), MasteryCooldownTooltip::format);
    }
    ...
    private static Text format(ItemStack stack, int baseTicks) {
        ...
        return Text.translatable(conditional ? "tooltip.simplyswordsmastery.base_cooldown"
                : "tooltip.simplyswordsmastery.mastered_cooldown", seconds);
    }
    ...
    private static List<UniqueAbilityDefinition> phases(Identifier profile) {
        if (!profile.getNamespace().equals("simplyswordsmastery")) return List.of();
