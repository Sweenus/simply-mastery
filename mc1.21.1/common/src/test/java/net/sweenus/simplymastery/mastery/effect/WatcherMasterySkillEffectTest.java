...
final class WatcherMasterySkillEffectTest {
    ...
    @Test
    void everyWatcherNodeRoutesToTheAbyssalSpectralAbilityEffect() {
    ...
    void guardNodesNoLongerRewriteTheOmenSlownessOrDuration() {
        AbyssalSpectralMasteryTuning slowness = tune(List.of(12, 20, 21, 25));
        ...
        AbyssalSpectralMasteryTuning duration = tune(List.of(9, 24));
    ...
    void gatheringDoomKeepsItsOwnRampWhenClaimedVitalityIsOwned() {
        AbyssalSpectralMasteryTuning tuning = tune(List.of(13, 24));
    ...
    void capstonesConfigureTheirOwnConsumers() {
        AbyssalSpectralMasteryTuning manyEyed = tune(List.of(7));
        ...
        AbyssalSpectralMasteryTuning absolute = tune(List.of(26));
    ...
    private static AbyssalSpectralMasteryTuning tune(List<Integer> slots) {
        MasteryProfile profile = BuiltInFamilyProfiles.profile("watcher_claymore");
        UniqueAbilityDefinition definition = AbyssalSpectralMasteryAbilities.WATCHER_OMEN;
        UniqueAbilityTuning.Builder builder = UniqueAbilityTuning.builder(definition);
        builder.set(AbyssalSpectralMasteryAbilities.COOLDOWN_TICKS, 180);
