...
final class MasteryNodeAuditReportTest {
    @Test
    void reportAccountsForEveryNodeThroughStormsEdgeReview() {
        ...
        assertTrue(report.contains("Reviewed: 27"));
        assertTrue(report.contains("Pending: 1377"));
        assertTrue(report.contains("| verified | 27 |"));
