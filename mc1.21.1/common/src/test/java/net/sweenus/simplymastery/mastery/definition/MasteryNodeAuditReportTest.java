...
final class MasteryNodeAuditReportTest {
    @Test
    void reportAccountsForEveryNodeThroughTheFirstPhase5FireReview() {
        ...
        assertTrue(report.contains("Reviewed: 540"));
        assertTrue(report.contains("Pending: 864"));
        assertTrue(report.contains("| verified | 540 |"));
