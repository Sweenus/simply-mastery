...
final class TwistedBladeMasterySkillEffectTest {
    ...
    void allNodesRouteOnlyToTheirOwnedDefinition() {
        List<UniqueAbilityDefinition> definitions = List.of(DeathShadowBloodMasteryAbilities.TWISTED_FEROCITY,
                DeathShadowBloodMasteryAbilities.TWISTED_CRESCENDO, DeathShadowBloodMasteryAbilities.TWISTED_FINALE);
    ...
    void pathsAndCapstonesKeepIndependentValues() {
        DeathShadowBloodMasteryTuning ferocity = tune(DeathShadowBloodMasteryAbilities.TWISTED_FEROCITY,
                List.of(0, 1, 2, 4, 6, 8));
        ...
        DeathShadowBloodMasteryTuning crescendo = tune(DeathShadowBloodMasteryAbilities.TWISTED_CRESCENDO,
        ...
        DeathShadowBloodMasteryTuning finale = tune(DeathShadowBloodMasteryAbilities.TWISTED_FINALE,
    ...
    private static boolean hasTwistedSetting(DeathShadowBloodMasteryTuning tuning) {
    ...
    private static DeathShadowBloodMasteryTuning tune(UniqueAbilityDefinition definition, List<Integer> nodes) {
        ...
        if (definition.cooldownKey().isPresent()) builder.set(DeathShadowBloodMasteryAbilities.COOLDOWN_TICKS, 1);
